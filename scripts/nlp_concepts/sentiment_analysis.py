...
# TextBlob
print("*" * 25)
print("Below example of Sentiment using TextBlob package")
...
# NLTK
print("*" * 25)
print("Below example of Sentiment using NLTK package")
 
# Download the VADER lexicon (if not alreadydownloaded)
